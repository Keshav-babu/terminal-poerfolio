var data = {
  name : [
    {name: 'Name', value: 'Keshav Mandal'}
  ],
  bio: [
    {name: 'Name', value: 'Keshav Mandal'},
    {name: 'Email', value: 'keshavmandal39@gmail.com'},
    {name: 'Phone', value: '+91 - 79034 17535'},
    {name: 'Country', value: 'India'},
    {name: 'City', value: 'Darbhanga , Bihar'}
  ],
  github: [
  ...
  socials: [
    ...
    {name: 'GitHub', value: 'https://github.com/Keshav-babu'},
    {name: 'Instagram', value: 'https://www.instagram.com/keshavbabu742/'},
    {name: 'Website', value: 'https://cocky-darwin-c131ab.netlify.app'}
  ]
}